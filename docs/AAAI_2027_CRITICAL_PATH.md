...
3. **Task retention.** Move beyond subset100. Full GSM8K is now measured for
   ...
   first 1500-row prefix has matched task, runtime, and statistics gates. The
...
1. Continue the generated full-MMLU plan:
   ...
   GPTQModel variant. The first 1500-row prefix is gated; full-MMLU completion
