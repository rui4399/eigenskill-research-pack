...
| `official_gptqmodel_task_execution_qwen25_1p5b_20` | task execution smoke | `outputs/OFFICIAL_GPTQMODEL_TASK_EXECUTION_QWEN25_1P5B_20_MATRIX_2026_06_08.md` | The saved Qwen2.5-1.5B GPTQModel W4/G128 artifact reloads through `gptq_torch` and runs MMLU20 plus GSM8K20 public task smokes under a 90% GPU guard; this is native-package execution evidence, not leaderboard-scale task retention or GPTQ superiority. |
