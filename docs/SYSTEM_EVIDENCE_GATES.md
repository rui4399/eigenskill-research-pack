...
| `official_gptqmodel_public_calib_smoke` | external PTQ readiness | `outputs/OFFICIAL_GPTQMODEL_PUBLIC_CALIB_QWEN25_0P5B_WIKITEXT2_2026_06_07.md` | A public-calibration GPTQModel W4 group-128 smoke quantizes under guard, saves/reloads a local artifact with `gptq_torch`, and evaluates a tiny public WikiText2 PPL slice; this is partial official-package evidence, not GPTQ/AWQ competitive coverage. |
