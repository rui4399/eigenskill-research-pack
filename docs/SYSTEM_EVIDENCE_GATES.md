...
Current status: **47 / 47 gates pass**.
...
| `official_gptqmodel_public_calib_1p5b_smoke` | official PTQ readiness | `outputs/OFFICIAL_GPTQMODEL_PUBLIC_CALIB_QWEN25_1P5B_SMOKE4_GATE_2026_06_08.md` | A public-calibrated GPTQModel W4 group-128 Qwen2.5-1.5B artifact is freshly quantized under a 90% VRAM guard, saved as an eight-file local artifact, and evaluated on a 4-prompt WikiText2 PPL smoke with PPL ratio 1.1527; this is scale-up readiness evidence, not complete GPTQ/AWQ competitiveness or task retention. |
...
are not counted in the current 47-gate paper-facing ledger.
