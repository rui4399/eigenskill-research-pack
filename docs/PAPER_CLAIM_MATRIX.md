...
| A minimal matched FP16-vs-AutoAWQ PPL probe can run locally under guard. | Qwen2.5-0.5B-Instruct FP16 and local AutoAWQ W4 group-128 artifact are evaluated on the same four-prompt slice: FP16 PPL 197.532, AutoAWQ PPL 232.863, PPL ratio 1.1789, peak guard VRAM ratio 0.6057. | `outputs/OFFICIAL_AWQ_MATCHED_PPL_GATE_2026_06_07.md`, `outputs/OFFICIAL_AWQ_MATCHED_PPL_QWEN25_0P5B_2026_06_07.md` | Minimal readiness PPL probe only; not WikiText2/C4, not task retention, and not a complete official AWQ/GPTQ competitive baseline. |
