...
| Official PTQ probes | AutoAWQ/GPTQModel Qwen2.5-0.5B W4/G128 readiness, tiny task smoke, and matched 50-row task subset paths | readiness only |
...
Current ledger status: **27 / 27 gates pass**.
