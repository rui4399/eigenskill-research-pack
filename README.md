...
| Official PTQ probes | AutoAWQ/GPTQModel Qwen2.5-0.5B W4/G128 readiness, aligned expanded 16-prompt public PPL gates, tiny task smoke, matched 50-row task subset paths, deterministic IFEval-style execution smoke, and a matched local baseline pack | local evidence only; quantized paths save VRAM but are slower here |
...
Current ledger status: **33 / 33 gates pass**.
...
python train_python/build_current_evidence_ledger.py --expected-gate-count 33
