...
|---|---:|---:|---:|---:|
| baseline | 5 / 12 | 0.4167 | 22.0725 | 0.187943 |
| fused | 5 / 12 | 0.4167 | 20.2123 | 0.276915 |
...
| fused | `gsm8k_style_selected_rows_bytes` | `number` | false | `131072` | `<think>  </think>  Each row has 4096 signed 4-bit weights, and two weights fit in one byte. Therefore, the number of pac` |
