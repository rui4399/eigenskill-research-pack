...
|---|---:|---:|---:|---:|
| baseline | 46 / 84 | 0.5476 | 22.7392 | 0.097409 |
| fused | 45 / 84 | 0.5357 | 21.0827 | 0.116330 |
...
| fused | `stress_mcq_extra_000` | `mcq` | false | `A` | `<think>  </think>  B. README text` |
...
| fused | `stress_number_extra_002` | `number` | false | `49` | `<think>  </think>  4033 MiB rounded down is 4033. To find the percentage, divide by 8151:  ` |
...
| fused | `stress_number_extra_005` | `number` | false | `512` | `<think>  </think>  A 4-bit row with 1024 weights uses **1 packed byte**.   Final answer: **1**` |
...
| fused | `stress_contains_all_extra_000` | `contains_all` | false | `['q-only', 'larger', 'slice']` | `<think>  </think>  The next validation target for the selected role policy is to ensure that all users are properly conf` |
...
| fused | `stress_contains_all_extra_003` | `contains_all` | false | `['packed', 'runtime', 'evidence']` | `<think>  </think>  A **conservative systems claim** refers to a claim that emphasizes the importance of **conservative p` |
...
| fused | `stress_contains_all_extra_005` | `contains_all` | false | `['split', 'quality', 'regression']` | `<think>  </think>  Role policies need multiple splits for several key reasons:  1. **To Prevent Conflicts**: When a role` |
| fused | `stress_contains_none_extra_000` | `contains_none` | true | `['final']` | `<think>  </think>  A Q-only candidate is someone who only submits questions without providing any answers.` |
| fused | `stress_contains_none_extra_001` | `contains_none` | true | `['proof']` | `<think>  </think>  A stress benchmark is a measure of how much stress a person experiences under certain conditions. It ` |
...
| fused | `stress_contains_none_extra_005` | `contains_none` | true | `['unlimited']` | `<think>  </think>  GPU memory guarding refers to the process of protecting GPU memory from unauthorized access or misuse` |
...
| fused | `stress_sentence_count_extra_002` | `sentence_count` | true | `{'count': 1}` | `<think>  </think>  Timeout results are excluded in exactly one sentence because they are not considered valid or relevan` |
...
| fused | `stress_all_of_extra_001` | `all_of` | true | `[{'type': 'sentence_count', 'answer': {'count': 1}}, {'type': 'contains_all', 'answer': ['q-only', 'stress']}, {'type': 'contains_none', 'answer': ['proof']}]` | `<think>  </think>  Q-only and stress are both important aspects of communication.` |
...
| fused | `stress_all_of_extra_004` | `all_of` | true | `[{'type': 'json_keys', 'answer': ['timeout', 'citation']}, {'type': 'contains_none', 'answer': ['valid']}]` | `<think>  </think>  ```json {   "timeout": "1000",   "citation": "https://example.com/citation" } ```` |
