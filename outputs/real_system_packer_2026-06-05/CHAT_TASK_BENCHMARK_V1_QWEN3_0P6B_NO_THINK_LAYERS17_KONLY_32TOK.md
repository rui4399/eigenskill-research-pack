...
|---|---:|---:|---:|---:|
| baseline | 5 / 12 | 0.4167 | 22.0039 | 0.170074 |
| fused | 5 / 12 | 0.4167 | 20.7055 | 0.151593 |
...
| fused | `ifeval_style_deployment_metrics` | `contains_all` | false | `['ttft', 'throughput', 'memory']` | `<think>  </think>  Three physical deployment metrics for an edge LLM are:  1. **TTFT (Total Time to First Token)** – Thi` |
