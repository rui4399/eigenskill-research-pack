...
Date: `2026-06-07T08:34:07+00:00`
Status: **PASS**
Gates: `31 / 31` passed
...
|---|---|---|---|---|
| `public_hygiene` | repo hygiene | **PASS** | tracked files 1934; forbidden files 0; placeholders 0 | `outputs/real_system_packer_2026-06-05/public_repo_hygiene_gate_2026_06_06.json` |
...
| `paper_evidence_alignment` | paper alignment | **PASS** | required refs 20; missing refs 0; paper paths 26; missing paths 0; unsafe claims 0; stale tokens 0; ledger gates 31 | `outputs/paper_evidence_alignment_gate_2026_06_07.json` |
