...
Date: `2026-06-07T03:43:32+00:00`
Status: **PASS**
Gates: `28 / 28` passed
...
|---|---|---|---|---|
| `public_hygiene` | repo hygiene | **PASS** | tracked files 1816; forbidden files 0; placeholders 0 | `outputs/real_system_packer_2026-06-05/public_repo_hygiene_gate_2026_06_06.json` |
...
| `paper_evidence_alignment` | paper alignment | **PASS** | required refs 15; missing refs 0; paper paths 21; missing paths 0; unsafe claims 0; stale tokens 0; ledger gates 28 | `outputs/paper_evidence_alignment_gate_2026_06_07.json` |
...
| `official_ptq_matched_baseline_pack` | matched PTQ baseline | **PASS** | max PPL ratio 1.2949; max drop 0.0400; max VRAM ratio 0.9010; max tok/s ratio 0.3315; VRAM 0.6148 | `outputs/official_ptq_matched_baseline_pack_qwen25_0p5b_2026_06_07.json` |
