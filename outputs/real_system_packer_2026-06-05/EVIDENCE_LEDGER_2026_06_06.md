...
|---|---|---|---|---|
| `public_hygiene` | repo hygiene | **PASS** | tracked files 1642; forbidden files 0; placeholders 0 | `outputs/real_system_packer_2026-06-05/public_repo_hygiene_gate_2026_06_06.json` |
...
| `paper_evidence_alignment` | paper alignment | **PASS** | required refs 8; missing refs 0; paper paths 13; missing paths 0; unsafe claims 0; stale tokens 0; ledger gates 21 | `outputs/paper_evidence_alignment_gate_2026_06_07.json` |
