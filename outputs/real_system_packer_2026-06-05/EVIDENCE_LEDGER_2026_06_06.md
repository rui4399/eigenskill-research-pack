...
Date: `2026-06-07T01:47:25+00:00`
Status: **PASS**
Gates: `24 / 24` passed
...
|---|---|---|---|---|
| `public_hygiene` | repo hygiene | **PASS** | tracked files 1760; forbidden files 0; placeholders 0 | `outputs/real_system_packer_2026-06-05/public_repo_hygiene_gate_2026_06_06.json` |
...
| `paper_evidence_alignment` | paper alignment | **PASS** | required refs 11; missing refs 0; paper paths 17; missing paths 0; unsafe claims 0; stale tokens 0; ledger gates 24 | `outputs/paper_evidence_alignment_gate_2026_06_07.json` |
