...
Date: `2026-06-07T06:47:19+00:00`
Status: **PASS**
Gates: `30 / 30` passed
...
|---|---|---|---|---|
| `public_hygiene` | repo hygiene | **PASS** | tracked files 1844; forbidden files 0; placeholders 0 | `outputs/real_system_packer_2026-06-05/public_repo_hygiene_gate_2026_06_06.json` |
...
| `calibration_seed_stability` | calibration robustness | **PASS** | cases 3; prompt selections 3; finite pairs 3; min rho 0.2741; min top20 0.4286; mean Spearman 0.4230; mean Jaccard 0.5517; top20 Jaccard 0.4652 | `outputs/calibration_seed_stability_qwen25_0p5b_2026_06_07.json` |
...
| `paper_evidence_alignment` | paper alignment | **PASS** | required refs 19; missing refs 0; paper paths 25; missing paths 0; unsafe claims 0; stale tokens 0; ledger gates 30 | `outputs/paper_evidence_alignment_gate_2026_06_07.json` |
