...
Date: `2026-06-07T18:26:25+00:00`
Status: **PASS**
Gates: `47 / 47` passed
...
|---|---|---|---|---|
| `public_hygiene` | repo hygiene | **PASS** | tracked files 2201; forbidden files 0; placeholders 0 | `outputs/real_system_packer_2026-06-05/public_repo_hygiene_gate_2026_06_06.json` |
...
| `paper_evidence_alignment` | paper alignment | **PASS** | required refs 36; missing refs 0; paper paths 45; missing paths 0; unsafe claims 0; stale tokens 0; ledger gates 47 | `outputs/paper_evidence_alignment_gate_2026_06_08.json` |
...
| `official_gptqmodel_public_calib_1p5b_smoke` | ptq comparator | **PASS** | eval slices 1; eval tokens 380; VRAM 0.8543 | `outputs/official_gptqmodel_public_calib_qwen25_1p5b_smoke4_gate_2026_06_08.json` |
