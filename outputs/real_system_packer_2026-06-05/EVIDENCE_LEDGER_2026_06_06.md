...
Date: `2026-06-06T20:09:36+00:00`
Status: **PASS**
Gates: `22 / 22` passed
...
|---|---|---|---|---|
| `public_hygiene` | repo hygiene | **PASS** | tracked files 1655; forbidden files 0; placeholders 0 | `outputs/real_system_packer_2026-06-05/public_repo_hygiene_gate_2026_06_06.json` |
...
| `paper_evidence_alignment` | paper alignment | **PASS** | required refs 9; missing refs 0; paper paths 15; missing paths 0; unsafe claims 0; stale tokens 0; ledger gates 22 | `outputs/paper_evidence_alignment_gate_2026_06_07.json` |
