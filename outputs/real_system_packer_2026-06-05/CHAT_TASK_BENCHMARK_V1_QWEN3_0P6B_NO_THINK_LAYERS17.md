...
|---|---:|---:|---:|---:|
| baseline | 3 / 12 | 0.2500 | 22.8676 | 0.174316 |
| fused | 3 / 12 | 0.2500 | 19.4066 | 0.247880 |

## Rows

| split | id | type | passed | expected | generated |
|---|---|---|---:|---|---|
| baseline | `mmlu_style_memory_metric` | `mcq` | false | `B` | `<think>  </think>  B. peak GPU memory` |
| baseline | `mmlu_style_math_benchmark` | `mcq` | false | `A` | `<think>  </think>  B. HumanEval` |
| baseline | `mmlu_style_calibration_instability` | `mcq` | false | `B` | `<think>  </think>  B. calibration split instability` |
...
| fused | `mmlu_style_memory_metric` | `mcq` | false | `B` | `<think>  </think>  B. peak GPU memory` |
| fused | `mmlu_style_math_benchmark` | `mcq` | false | `A` | `<think>  </think>  B. HumanEval` |
| fused | `mmlu_style_calibration_instability` | `mcq` | false | `B` | `<think>  </think>  B. calibration split instability` |
