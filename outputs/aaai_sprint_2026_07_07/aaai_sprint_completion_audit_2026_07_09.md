...
| P0 calibration size scaling | `complete_to_n512_sensitivity_with_downstream_boundary` | `aaai_sprint_calibration_alignment_2026_07_09.json`, `qwen25_1p5b_wikitext2_n512_seed0_sensitivity_2to4_budget3.json`, `qwen25_1p5b_n16_n32_n64_n128_n256_n512_csi_scaling_summary.json`, `qwen25_1p5b_wikitext2_n256_seed0_seed1_csi_consensus_2to4_budget3.json`, `qwen25_7b_n16_n32_n64_csi_scale_summary.json`, `aaai_scaling_512_prompt_manifest_2026_07_09.json`, `aaai_scaling_512_readiness_audit_2026_07_09.json` | n512 sensitivity/allocation is complete for 1.5B as a full-pool single run, but n512 two-split consensus and n256/n512 downstream retention are not claimed complete. |
...
- n256/n512 downstream retention and n512 two-split consensus are not complete; 1.5B sensitivity/allocation scaling is now recorded through a true 512-prompt full-pool run.
