...
Added on 2026-07-09: `qwen25_1p5b_wikitext2_n512_seed0_sensitivity_2to4_budget3.{json,md}` and `qwen25_1p5b_n16_n32_n64_n128_n256_n512_csi_scaling_summary.{json,md}` record completed Qwen2.5-1.5B n512 full-pool sensitivity/allocation evidence. The run uses 512 prompts and covers 197/197 modules; avg bits is 2.9988 and protected positive-delta ratio is 0.9136. This closes the sensitivity side of the calibration-size curve through n512, while explicitly not claiming n512 two-split consensus or n512 downstream retention.
