...
1. Audit LFM2.5 tokenizer/template behavior on plain text and add a second
   prompt source before sensitivity allocation.
2. Run a Qwen3-0.6B or Qwen3-1.7B interaction-aware transfer check because
   those models already have stronger baseline evidence.
