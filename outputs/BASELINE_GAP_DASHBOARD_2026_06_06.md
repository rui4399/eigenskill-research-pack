...
Date: `2026-06-07T00:44:58+00:00`
...
| `official_awq_gptq_competitive` | external_ptq | high | True | **partial** | 0 | 0 | 28 | 2 | autoawq=yes, awq=yes, auto_gptq=no, gptqmodel=yes | Smoke and proxy artifacts are useful readiness diagnostics, but they do not cover faithful official AWQ/GPTQ baseline claims without matched calibration, budget, PPL, and task comparisons. |
