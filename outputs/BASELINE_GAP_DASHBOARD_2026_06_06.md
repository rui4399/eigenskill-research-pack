...
Date: `2026-06-07T00:03:14+00:00`
...
| `official_gptqmodel_public_calibrated_smoke` | external_ptq_readiness | optional | False | **covered** | 3 | 0 | 0 | 0 | gptqmodel=yes | Partial official-package readiness: it proves GPTQModel can quantize, save, reload, and evaluate a tiny public slice locally, but it is not a full GPTQ/AWQ competitive baseline or task-retention result. |
| `official_awq_gptq_competitive` | external_ptq | high | True | **partial** | 0 | 0 | 21 | 2 | autoawq=yes, awq=yes, auto_gptq=no, gptqmodel=yes | Smoke and proxy artifacts are useful readiness diagnostics, but they do not cover faithful official AWQ/GPTQ baseline claims without matched calibration, budget, PPL, and task comparisons. |
