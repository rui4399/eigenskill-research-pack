...
smoke over 20 MMLU abstract-algebra rows and 20 GSM8K rows, obtaining 7/20 and
1/20 respectively, with mean 10.0685 tokens/s, mean TTFT 0.352708 s, and peak
guarded VRAM ratio 0.6672; this is counted only as native-package execution
evidence, not leaderboard-scale task retention or GPTQ superiority.
...
| Qwen2.5-1.5B GPTQModel task-execution smoke | Saved GPTQModel W4/G128 artifact on 20 MMLU abstract-algebra plus 20 GSM8K rows; see `outputs/OFFICIAL_GPTQMODEL_TASK_EXECUTION_QWEN25_1P5B_20_MATRIX_2026_06_08.md`. | The native GPTQModel path reloads and generates under guard, with 7/20 MMLU, 1/20 GSM8K, mean 10.0685 tokens/s, mean TTFT 0.352708 s, and peak guard VRAM ratio 0.6672. | Not leaderboard-scale task retention, not GPTQ superiority, not matched FP16/AWQ comparison, not production runtime, and not SOTA PTQ. |
