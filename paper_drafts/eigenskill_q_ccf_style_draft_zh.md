...
>
> 状态更新，2026-06-07：本中文稿保留为历史草稿。当前更接近投稿骨架的版本是 `paper_drafts/eigenskill_q_research_draft_en_2026_06_07.md`，它已纳入 23-gate evidence ledger、calibration robustness stress、consensus transfer boundary、interaction-aware swap boundary、public-task model ladder、official PTQ task-execution smoke 和 paper-evidence alignment gate。若两者不一致，以新版英文稿和 `docs/PAPER_CLAIM_MATRIX.md` 为准。
