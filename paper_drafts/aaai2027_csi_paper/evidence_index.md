...
The current paper-facing narrative uses six audit-system figures:

- Figure 1, CSI system pipeline:
  `paper_drafts/aaai2027_csi_paper/figures/fig1_pipeline.png`
- Figure 2, CSI phase-transition curve:
...
`framework_overview.png`, `csi_stability_curves.png`,
`failure_separation_map.png`, and `regime_dominance_map.png`.
