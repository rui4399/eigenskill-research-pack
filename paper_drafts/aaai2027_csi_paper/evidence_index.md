...
- Regime dominance audit:
  `paper_drafts/aaai2027_csi_paper/figures/regime_dominance_map.png`
  Generated by `paper_drafts/aaai2027_csi_paper/scripts/make_dominance_figures.ps1`.
  Filled cells use committed full-retention, local PPL-smoke, and low-bit
  scaffold artifacts; missing cells are deliberately marked as missing.
- CSI stability curves:
  `paper_drafts/aaai2027_csi_paper/figures/csi_stability_curves.png`
- Constraint effect landscape:
  `paper_drafts/aaai2027_csi_paper/figures/constraint_effect_landscape.png`
  Generated by `paper_drafts/aaai2027_csi_paper/scripts/make_dominance_figures.ps1`
  from the Qwen2.5/SmolLM2 CSI curves, Q-Palette-style budget gate, and local
  GPU fake-quant PPL smoke summaries.
- Failure separation map:
  `paper_drafts/aaai2027_csi_paper/figures/failure_separation_map.png`
  Generated by `paper_drafts/aaai2027_csi_paper/scripts/make_dominance_figures.ps1`.
...
- The new dominance map is therefore an audit map, not a dominance claim. It
