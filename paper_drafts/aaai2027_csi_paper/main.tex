...
The current evidence is based on reproducible CSI measurements and a lightweight
evaluation pipeline plus matched native-PTQ downstream retention on full Qwen2.5-1.5B
...
run before extending the paper beyond its current robustness-plus-retention
evaluation scope.
...
evidence lines. CSI provides a diagnostic signal for analyzing robustness in PTQ
