...
feasibility run. These rows move the paper beyond a calibration-only diagnosis
while still separating measured evidence from state-of-the-art or production
inference claims.
\end{abstract}
